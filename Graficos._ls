...
(DEFUN ARREEJE ()
  (cond
    ((= dbl1 "0")
      (set_tile "dbl5" "Nam.Axis X")
      (set_tile "dbl7" "Dist.X")
    )
    ((= dbl1 "1")
      (set_tile "dbl5" "Nam.Axis Y")
...
(DEFUN ARREVIGAS ()
  (cond
    ((= vicol "0")
      (mode_tile "vc1" 0)
      (set_tile "vct2" "Beam Height")
      (set_tile "vct1" "Factor Y")
      (set_tile "vct0" "Dist.Column")
      (set_tile "vct3" "Dist.Vain X")
      (set_tile "vct4" "Low Column")
      (set_tile "vct5" "Top Column")
    ...
    ((= vicol "1")
      ...
      (set_tile "vct1" "----------------")
      (set_tile "vct0" "Dist. Beam")
      (set_tile "vct3" "Dist.Vain Y")
      (set_tile "vct4" "  Beam Left ")
      (set_tile "vct5" "  Beam Right ")
      (set_tile "vct6" "   Beams    ")
...
(DEFUN ARREESTRIBOS ()
  (cond
    ((= vicole "0")
      (set_tile "evct1" "Thick. Left@")
      (set_tile "evct2" "Thick. Cen@")
      (set_tile "evct3" "Thick. Right@")
      (set_tile "evct4" "Porcen. Left%")
      (set_tile "evct5" "Porcen. Cen%")
      (set_tile "evct6" "Porcen. Right%")
    )
    ((= vicole "1")
      (set_tile "evct1" "Thick. Low@")
      (set_tile "evct2" "Thick. Cen@")
      (set_tile "evct3" "Thick. Top@")
      (set_tile "evct4" "Porcen. Low%")
      (set_tile "evct5" "Porcen. Cen%")
      (set_tile "evct6" "Porcen. Top%")
    )
  )
)
;-----------------------
